...
const DashboardPage = () => {
  ...
  const fetchTaskData = () => {
    // Example task data
    const data = [
      { id: 1, name: 'Vel', institution: 'Institution A', email: 'cbv@gmail.com' },
      { id: 2, name: 'Yogesh', institution: 'Institution B', email: 'cbv@gmail.com' },
  ...
  const handleItemClick = (item) => {
    ...
    switch (item) {
      case 'Courses':
        setTableData([
          { id: 1, name: 'CSE', details: 'Computer Science Engineering' },
          { id: 2, name: 'IT', details: 'Information technology' },
          { id: 3, name: 'AI', details: 'Artificial intelligence' },
          { id: 4, name: 'EEE', details: 'Electrical and Electronic Engineering' },
          { id: 5, name: 'ECE', details: 'Electronics and Communication Engineering' },
        ]);
        break;
      case 'Students':
        setTableData([
  ...
  return (
    <div className={classes.root}>
      ...
      <Dialog open={openDialog} onClose={handleCloseDialog}>
        ...
        <DialogContent>
          <DialogContentText>
            Write your  message {selectedMember && selectedMember.name}.
          </DialogContentText>
          <TextareaAutosize rowsMin={3} placeholder="Write your reply..." fullWidth />
        </DialogContent>
        <DialogActions>
